...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { amount: @claim.amount, description: @claim.description, name: @claim.name } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { amount: @claim.amount, description: @claim.description, name: @claim.name } }
